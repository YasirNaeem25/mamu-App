...
function EventData({ navigation, route }) {
    const { startdate, enddate, eventName, eventimage, eventId, externalLink, location } = route.params;
    const ref = useRef();
    ...
    return (
        <SafeAreaView>
            <ScrollView>
                <View style={{ height: 712, backgroundColor: '#F5F5F5', paddingBottom: 13 }}>
                    <View style={styles.MainBox}>

                        <View style={{ alignSelf: 'center' }}>
                            <Text style={{ fontSize: 18 }}>Share Your Event</Text>
                        </View>
                        <View style={{  alignItems: 'center', gap: 13, flexDirection: 'row', alignSelf: 'flex-start' }}>
                            ...
                            <View>
                                ...
                                <View style={{ display: 'flex', alignItems: 'center', flexDirection: 'row' }}>
                                    ...
                                    <View>
                                        <Text style={{ fontSize: 12, color: '#666666' }}>{location}</Text>
                                    </View>
                                </View>
                            </View>
                        </View>
                            ...
                            <View>
                                ...
                                <View style={{ paddingTop: 23, padding: 15, }} >
                                    ...
                                    <View style={{ width: '100%', paddingTop: 10 }} >
                                        <Button onPress={() => { navigation.navigate('Events') }} color='#23B7C5' label='GO TO EVENT' />
                                    </View>
                                </View>
                            </View>
                        </View>
